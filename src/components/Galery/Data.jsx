export const GaleryObjOne = {
  ...
  description: 'Rua Gomes Carneiro 1098, Bagé - Centro, Rio Grande do Sul',
...
export const GaleryObjTwo = {
  ...
  darkText: !true,
  hasText: false,
  img2: '/images/baixo.png',
};

export const GaleryObjThree = {
  id: 'galery3',
  lightBg: true,
  lightText: false,
  lighttextDesc: false,
